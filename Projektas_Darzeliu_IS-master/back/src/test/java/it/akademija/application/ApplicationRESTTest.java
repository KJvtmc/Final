...
public class ApplicationRESTTest {
	...
	public void testProcessConfirmQueue() throws Exception {
		...
		MvcResult getQueueInfoByChild = mvc.perform(get("/api/eile/manager/queue")
				.param("search", "49902251236").param("page", "1").param("size", "10")).andExpect(status().isOk()).andReturn();
