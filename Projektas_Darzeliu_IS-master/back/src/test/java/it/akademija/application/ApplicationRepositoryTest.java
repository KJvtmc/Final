...
public class ApplicationRepositoryTest {
	...
	public void itShouldProcessApplications() {
		...
		Kindergarten first = kindergartenDAO
				.save(new Kindergarten("123456789", "Pavadinimas 1", "Adresas 2", "Direktorius", "Seniunija", 12, 12));
		Kindergarten second = kindergartenDAO
				.save(new Kindergarten("146325698", "Pavadinimas 2", "Adresas 3", "Direktorius", "Seniunija", 12, 12));
		Kindergarten third = kindergartenDAO
				.save(new Kindergarten("369258147", "Pavadinimas 3", "Adresas 4", "Direktorius", "Seniunija", 12, 12));
