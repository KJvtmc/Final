...
public class KindergartenRepositoryTest {
	...
	public void itShoulSaveFindDeleteKindergarten() {
		...
		kindergarten.setDirector("Direktorius");
		...
		assertFalse(kindergartenDAO.findAllWithNonZeroCapacity(Sort.by("name").ascending()).isEmpty());
		assertTrue(kindergartenDAO.findAllWithZeroCapacity(Sort.by("name").ascending()).isEmpty());
